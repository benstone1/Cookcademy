...
extension Recipe {
    ...
    static let testRecipes: [Recipe] = [
        Recipe(mainInformation: MainInformation(name: "Dad's Mashed Potatoes",
                 ...
                 Recipe(mainInformation: MainInformation(name: "Best Brownies Ever (For Real)",
                 ...
                 Recipe(mainInformation: MainInformation(name: "Classic Omelet and Greens",
                 ...
                 Recipe(mainInformation: MainInformation(name: "Peanut Buffer Granola Bowl",
                 ...
                 Recipe(mainInformation: MainInformation(name: "Chocolate Chip Banana Bread",
